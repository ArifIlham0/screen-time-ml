...
def predict_from_api(app_usage_time, screen_time, open_apps, age):
    predictor = SmartphoneUsagePredictor()
    prediction, confidence = predictor.predict_usage_intensity(app_usage_time, screen_time, open_apps, age)
    insights = predictor.get_usage_insights(app_usage_time, screen_time, open_apps, age)
